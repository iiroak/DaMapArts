...
>
	<div class="beta-content">
		...
		<div class="beta-links">
			<a href="https://github.com/iiroak/DaMapArts" target="_blank" rel="noopener noreferrer" class="beta-link beta-link-github">
			...
			<a href="https://discord.gg/eeJyhMaT7F" target="_blank" rel="noopener noreferrer" class="beta-link beta-link-discord">
				<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
